...
public:
	...
	void StreamlineEvaluateFGSR_SR(FRHICommandList& CmdList, const TArrayView<const FRHIStreamlineResource> InputOutput, sl::FrameToken* FrameToken, uint32 ViewID);
